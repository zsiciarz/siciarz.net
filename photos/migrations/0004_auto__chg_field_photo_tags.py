...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'photos_photo', 'tags', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'text', null=True))

    def backwards(self, orm):

        # Changing field 'Photo.tags'
        db.alter_column(u'photos_photo', 'tags', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'varchar(127)', null=True))
    ...
    models = {
        ...
        u'photos.photo': {
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'tags': ('djorm_pgarray.fields.ArrayField', [], {'default': 'None', 'dbtype': "u'text'", 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        }
    }
