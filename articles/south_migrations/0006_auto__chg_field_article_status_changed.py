...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.status_changed'
        db.alter_column(u'articles_article', 'status_changed', self.gf('model_utils.fields.MonitorField')(monitor=u'status'))

    def backwards(self, orm):

        # Changing field 'Article.status_changed'
        db.alter_column(u'articles_article', 'status_changed', self.gf('model_utils.fields.MonitorField')(monitor='status'))
