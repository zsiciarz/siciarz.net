...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'articles_article', 'language',
                      self.gf('django.db.models.fields.CharField')(default='pl', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.language'
        db.delete_column(u'articles_article', 'language')
