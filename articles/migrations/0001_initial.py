...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'articles_article', (
            ...
            ('summary', self.gf('markupfield.fields.MarkupField')(rendered_field=True)),
            ('summary_markup_type', self.gf('django.db.models.fields.CharField')(default='markdown', max_length=30)),
            ('content', self.gf('markupfield.fields.MarkupField')(rendered_field=True)),
            ('_summary_rendered', self.gf('django.db.models.fields.TextField')()),
