...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.is_static'
        db.add_column(u'articles_article', 'is_static',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.is_static'
        db.delete_column(u'articles_article', 'is_static')
    ...
    models = {
        u'articles.article': {
            ...
            'summary_markup_type': ('django.db.models.fields.CharField', [], {'default': "u'markdown'", 'max_length': '30'}),
