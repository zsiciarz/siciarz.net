...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.header_image'
        db.add_column(u'articles_article', 'header_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.header_image'
        db.delete_column(u'articles_article', 'header_image')
